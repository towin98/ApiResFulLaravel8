...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\TrimStrings::class, /*remover los espacio en blanco al inicio de una cadena*/
        \Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull::class,/*convierte un string vacio a algo nulo*/ 
    ];
